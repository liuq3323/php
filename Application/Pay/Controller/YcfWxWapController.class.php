...
class YcfWxWapController extends PayController
{
    ...
    public function Pay($array)
    {
        ...
        $notifyurl   = $this->_site . "Pay_YcfWxWap_notifyurl.html"; //异步通知
        $callbackurl = $this->_site . 'Pay_YcfWxWap_callbackurl.html'; //跳转通知
    ...
    public function notifyurl()
    {
        ...
        switch ($returncode) {
            case "1": 
                    $this->EditMoney($orderid, 'YcfAliSm', 0);
                echo 'ok';
                break;
            default:
                //Ê§°Ü
