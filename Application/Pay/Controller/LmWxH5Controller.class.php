...
class LmWxH5Controller extends PayController
{
    ...
    public function Pay($array)
    {
        ...
        $notifyurl = $this->_site ."Pay_LmWxH5_notifyurl.html"; //异步通知
        ...
        $callbackurl = $this->_site . 'Pay_LmWxH5_callbackurl.html'; //跳转通知
        $params  = [
            "version"    => '1.0',
            "merNo"           => $return['mch_id'],
    ...
    public function notifyurl()
    {
        ...
        if (isset($data['payState']) && $data['payState'] == '1') {
            ...
            if (strtoupper($newSign) == $sign) {
                $this->EditMoney($data['merOrderNo'], 'LmWxH5', 0);
                exit('success');
            } else {
