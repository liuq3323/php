...
class YcfQQSmController extends PayController
{
    ...
    public function Pay($array)
    {
        ...
        $notifyurl   = $this->_site . "Pay_YcfQQSm_notifyurl.html"; //异步通知
        $callbackurl = $this->_site . 'Pay_YcfQQSm_callbackurl.html'; //跳转通知
