...
class YcfQQWapController extends PayController
{
    ...
    public function Pay($array)
    {
        ...
        $notifyurl   = $this->_site . "Pay_YcfQQWap_notifyurl.html"; //异步通知
        $callbackurl = $this->_site . 'Pay_YcfQQWap_callbackurl.html'; //跳转通知
