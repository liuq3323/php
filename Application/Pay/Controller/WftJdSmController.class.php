...
class WftJdSmController extends PayController{
	...
	public function Pay($array){
		...
		$notifyurl = $this->_site . 'Pay_WftJdSm_notifyurl.html';

		$callbackurl = $this->_site . 'Pay_WftJdSm_callbackurl.html';
	...
	public function callbackurl(){
        ...
        if($pay_status <> 0){
            $this->EditMoney($_REQUEST["orderid"], 'WftJdSm', 1);
        }else{
            exit("error");
        }
	}
    ...
    public function notifyurl(){
        ...
        if($data['status'] == 0 && $respSign == $sign){
            $this->EditMoney($data["out_trade_no"], 'WftJdSm', 0);
            exit('success');
        }
