...
class RzfAliSmController extends PayController
{
    ...
    public function Pay($array)
    {
        ...
        $notifyurl = $this->_site ."Pay_RzfAliSm_notifyurl.html"; //异步通知
        ...
        $callbackurl = $this->_site . 'Pay_RzfAliSm_callbackurl_outtradeno_'.$return['orderid'].'.html'; //跳转通知
        $params  = [
    ...
    public function notifyurl()
    {
        ...
        if ($data['returncode'] == 'SUCCESS') {
            ...
            if ($newSign == $data['sign']) {
                $this->EditMoney($data['orderid'], 'RzfAliSm', 0);
                exit('ok');
            } else {
